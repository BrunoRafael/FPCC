...
```{r, fig.align='center', fig.cap="Figura 10 - Intervalo de confiança da diferença para python das modificações feitas na quarta-feira e na sexta-feira"}
# Agora a diferença das médias

b.diff.sd = bootstrap2(data = python_quarta$users, 
                           data2 = python_sexta$users,
                          sd)

sd.diff = CI.percentile(b.diff.sd, probs = c(.025, .975))
sd.diff

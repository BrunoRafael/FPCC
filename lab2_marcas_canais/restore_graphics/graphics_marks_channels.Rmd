...
print(g)
ggsave("restored_graph.pdf", width = 4.5, height = 3, bg = "transparent")
...
gastos_reais_por_estado <- gastos_reais_por_estado %>% rbind(gastos_ideais_por_estado)
View(gastos_reais_por_estado)
gastos_reais_por_estado %>%
  ggplot(aes(x = sgUF, 
             y = total_real_gasto)) + 
  geom_point(alpha = .7)+
  geom_line()+

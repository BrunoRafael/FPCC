...
```
 ...
 Os gastos totais com parlamentares para o Exercício da Atividade Parlamentar(CEAP) ultrapassaram os 138 milhões de reais nos últimos dois anos. As chamadas cotas são benefícios dados aos deputados para o exercício de suas atividades durante o seu mandato, além dos seus salários. Cada deputado tem direito a por exemplo direito a gastos com Passagens aéreas, divulgação das atividades parlamentares, pedágios, estacionamentos, alimentação, serviços postais, serviços de táxi, manutenção de escritório e etc.
...
Os dados do portal da camara apresentaram algumas inconsistências. Da melhor forma possível procuramos tratar os dados e sanar os problemas.
...
Agora vamos analisar com o que exatamente os deputados gastaram e como se comportam os parlamentares em relação a cada gasto.
...
Despesas do tipo "Divulgação da atividade parlamentar" são as que mais os deputados usam suas cotas em segundo lugar "Passagens aéreas" e em terceiro  comparando em valores absolutos

 Esse gráfico não diz muita coisa, mas podemos verificar que os deputados gastaram. Observe que o tipo de despesa "Divulgação da atividade parlamentar" é a despesa favorita dos deputados. Perceba que temos alguns casos especiais aqui, de valores muitos altos e que aparenta ser o motivo pelo qual essa despesa tem um valor tão alto, bem mais alto que as outras.
